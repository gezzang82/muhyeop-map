  ...
  if (!_dataLoadPromise) {
    _dataLoadPromise = (async () => {
      ...
      if (!isAdminPage && !_noTrack) {
        ...
        //  세션에 저장해 내부 이동/재접속에도 유지. utm_source도 인정.
        let _src = '';
        try {
        ...
        fetch('/api/places?visit=1', {
          ...
          body: JSON.stringify({ ref: document.referrer || '', src: _src, platform: _detectPlatform() })
        }).catch(() => {});
...
const CATEGORY_PINS = {
  ...
  '헤어':      { color: '#45C04D', icon: '<path d="M19.6667 21L15 16.3333L13.4333 17.9C13.5222 18.0667 13.5833 18.2444 13.6167 18.4333C13.65 18.6222 13.6667 18.8111 13.6667 19C13.6667 19.7333 13.4056 20.3611 12.8833 20.8833C12.3611 21.4056 11.7333 21.6667 11 21.6667C10.2667 21.6667 9.63889 21.4056 9.11667 20.8833C8.59444 20.3611 8.33333 19.7333 8.33333 19C8.33333 18.2667 8.59444 17.6389 9.11667 17.1167C9.63889 16.5944 10.2667 16.3333 11 16.3333C11.1889 16.3333 11.3778 16.35 11.5667 16.3833C11.7556 16.4167 11.9333 16.4778 12.1 16.5667L13.6667 15L12.1 13.4333C11.9333 13.5222 11.7556 13.5833 11.5667 13.6167C11.3778 13.65 11.1889 13.6667 11 13.6667C10.2667 13.6667 9.63889 13.4056 9.11667 12.8833C8.59444 12.3611 8.33333 11.7333 8.33333 11C8.33333 10.2667 8.59444 9.63889 9.11667 9.11667C9.63889 8.59444 10.2667 8.33333 11 8.33333C11.7333 8.33333 12.3611 8.59444 12.8833 9.11667C13.4056 9.63889 13.6667 10.2667 13.6667 11C13.6667 11.1889 13.65 11.3778 13.6167 11.5667C13.5833 11.7556 13.5222 11.9333 13.4333 12.1L21.6667 20.3333V21H19.6667ZM17 14.3333L15.6667 13L19.6667 9H21.6667V9.66667L17 14.3333ZM11.9417 11.9417C12.2028 11.6806 12.3333 11.3667 12.3333 11C12.3333 10.6333 12.2028 10.3194 11.9417 10.0583C11.6806 9.79722 11.3667 9.66667 11 9.66667C10.6333 9.66667 10.3194 9.79722 10.0583 10.0583C9.79722 10.3194 9.66667 10.6333 9.66667 11C9.66667 11.3667 9.79722 11.6806 10.0583 11.9417C10.3194 12.2028 10.6333 12.3333 11 12.3333C11.3667 12.3333 11.6806 12.2028 11.9417 11.9417ZM15.2333 15.2333C15.3 15.1667 15.3333 15.0889 15.3333 15C15.3333 14.9111 15.3 14.8333 15.2333 14.7667C15.1667 14.7 15.0889 14.6667 15 14.6667C14.9111 14.6667 14.8333 14.7 14.7667 14.7667C14.7 14.8333 14.6667 14.9111 14.6667 15C14.6667 15.0889 14.7 15.1667 14.7667 15.2333C14.8333 15.3 14.9111 15.3333 15 15.3333C15.0889 15.3333 15.1667 15.3 15.2333 15.2333ZM11.9417 19.9417C12.2028 19.6806 12.3333 19.3667 12.3333 19C12.3333 18.6333 12.2028 18.3194 11.9417 18.0583C11.6806 17.7972 11.3667 17.6667 11 17.6667C10.6333 17.6667 10.3194 17.7972 10.0583 18.0583C9.79722 18.3194 9.66667 18.6333 9.66667 19C9.66667 19.3667 9.79722 19.6806 10.0583 19.9417C10.3194 20.2028 10.6333 20.3333 11 20.3333C11.3667 20.3333 11.6806 20.2028 11.9417 19.9417Z" fill="#fff"/>' },
  ...
  '사진관':    { color: '#1AA0E3', icon: '<path d="M13 9L11.78 10.3333H9.66667C8.93333 10.3333 8.33333 10.9333 8.33333 11.6667V19.6667C8.33333 20.4 8.93333 21 9.66667 21H20.3333C21.0667 21 21.6667 20.4 21.6667 19.6667V11.6667C21.6667 10.9333 21.0667 10.3333 20.3333 10.3333H18.22L17 9H13ZM15 19C13.16 19 11.6667 17.5067 11.6667 15.6667C11.6667 13.8267 13.16 12.3333 15 12.3333C16.84 12.3333 18.3333 13.8267 18.3333 15.6667C18.3333 17.5067 16.84 19 15 19Z" fill="#fff"/><path d="M15 18.3333L15.8333 16.5L17.6667 15.6667L15.8333 14.8333L15 13L14.1667 14.8333L12.3333 15.6667L14.1667 16.5L15 18.3333Z" fill="#fff"/>' },
  ...
  '운동':      { color: '#E77844', icon: '<path d="M12 10C12.5523 10 13 10.4477 13 11V14H17V11C17 10.4477 17.4477 10 18 10H19C19.5523 10 20 10.4477 20 11V12H21C21.5523 12 22 12.4477 22 13V14H23C23.5523 14 24 14.4477 24 15C24 15.5523 23.5523 16 23 16H22V17C22 17.5523 21.5523 18 21 18H20V19C20 19.5523 19.5523 20 19 20H18C17.4477 20 17 19.5523 17 19V16H13V19C13 19.5523 12.5523 20 12 20H11C10.4477 20 10 19.5523 10 19V18H9C8.44772 18 8 17.5523 8 17V16H7C6.44772 16 6 15.5523 6 15C6 14.4477 6.44772 14 7 14H8V13C8 12.4477 8.44772 12 9 12H10V11C10 10.4477 10.4477 10 11 10H12Z" fill="#fff"/>' },
  ...
  privacy: {
    ...
    body: `
      ...
      <div class="about-section">
        ...
        · 앱 푸시 알림 설정 시: 앱 푸시 토큰(FCM)·기기 식별자, 알림 대상 관심 위치(좌표)·반경<br>
      ...
      <div class="about-section">
        ...
        <p class="about-desc">'내 주변 협찬' 표시를 위해 단말기의 현재 위치를 일회성으로 이용하며, 해당 위치정보는 서버에 저장하지 않습니다. 이용자는 브라우저·기기 설정에서 위치 권한을 거부할 수 있고, 거부 시 내 주변 관련 기능만 제한됩니다. 다만 이용자가 앱에서 '관심 지역 알림'을 켜는 경우, 알림 대상 지역을 판단하기 위해 관심 위치(좌표)·반경을 서버에 저장하며, 알림을 끄거나 회원 탈퇴 시 삭제합니다.</p>
      </div>
      <div class="about-section">
        ...
        · 위치정보(현재 위치): 저장하지 않음<br>
        · 앱 알림용 관심 위치·반경, 앱 푸시 토큰(FCM): 알림 해제 또는 회원 탈퇴 시까지 보유(해제 시 삭제)<br>
        · 이벤트 당첨자 연락처: 경품 발송 완료 후 즉시 파기<br>
        · 단, 관계 법령상 보존 의무가 있는 경우 해당 기간 동안 보관</p>
      </div>
      <div class="about-section">
        <div class="about-section-title">5. 제3자 제공 및 처리위탁</div>
        <p class="about-desc">서비스는 원칙적으로 개인정보를 외부에 제공하지 않습니다. 간편로그인은 카카오·네이버 인증을 이용하며 해당 사업자의 개인정보 처리에는 각 사의 방침이 적용됩니다. 또한 서비스 운영을 위해 클라우드 인프라(Vercel, Turso 등)에 데이터가 저장·처리되며, 앱 푸시 알림 발송을 위해 Google(Firebase Cloud Messaging)에 푸시 토큰이 전달됩니다.</p>
      </div>
      <div class="about-section">
