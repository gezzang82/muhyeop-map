...
협찬을 찾는 인플루언서/리뷰어를 위한 지도 서비스. 매장(장소) 위에 진행 중인 협찬 캠페인을 표시한다.

카테고리별 상세 문서:
- @docs/workflow.md — 배포/커밋 워크플로우, DB 안전 규칙 (가장 먼저 읽을 것)
...
- @docs/product/17-threads-daily.md — **매일 스레드 글 작성 패턴**(글 요청 시 반드시 이 규칙대로: 10줄 이내·쉬운 말·복붙 가능한 글 1개)
