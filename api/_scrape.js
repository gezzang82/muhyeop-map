...
function categoryByKeyword(content, name) {
  ...
  if (/사주|타로|운세|점집|(?<![가-힣])신점|철학관|작명|무속|명리|손금|관상|점사/.test(s)) return '기타'; // 신점: '혁신점'·'서신점' 등 지점명 오매치 방지
  if (/헬스|피트니스|필라테스|요가|골프|스크린골프|클라이밍|크로스핏|복싱|주짓수|테니스|스쿼시|\bPT\b|퍼스널\s*트레이닝|무에타이|킥복싱|펜싱|볼링|당구|다이빙|서핑|스케이트|양궁|크루즈|유람선|요트|배낚시|선상낚시|실내낚시|좌대낚시|바다낚시|낚시터|밤낚시|키즈수영|수영강습|수영\s*특강|수영교실|유아수영|아기수영|생존수영|승마클럽|승마체험|승마장|승마공원|롤러장|롤러스케이트|트램폴린|점핑\s*다이어트/.test(s)) return '기타';
  ...
  if (/약손|안마|마사지|지압|경락|스웨디시|발마사지|타이마사지|풋마사지|스포츠마사지|림프|테라피|족욕|디톡스\s*족욕|웰리스|웰니스|상담센터|심리상담|전화상담|방문상담|발달센터|치유센터|금거래소|금은방|귀금속|결혼정보|소개팅|컨설팅|신당|(?<![가-힣])신점|보살|운전면허/.test(s)) return '기타';
  ...
  if (/네일|피부|왁싱|헤어|미용|에스테틱|태닝|속눈썹|반영구|필러|보톡스|두피|체형|다이어트|\b펌\b|염색|풋앤바디|바디케어|스킨케어|피부관리|메이크업|브로우|눈썹|슈가링|제모|타투|\bSMP\b|두피채움|페디큐어|풋케어|발각질|내성발톱|발톱무좀/.test(s)) return '뷰티';
