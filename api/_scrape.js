...
function categoryByKeyword(content, name) {
  ...
  if (/헬스|피트니스|필라테스|요가|골프|스크린골프|클라이밍|크로스핏|복싱|주짓수|테니스|스쿼시|\bPT\b|퍼스널\s*트레이닝|무에타이|킥복싱|펜싱|볼링|당구|다이빙|서핑|스케이트|양궁|크루즈|유람선|요트/.test(s)) return '기타';
  ...
  if (/약손|안마|마사지|지압|경락|스웨디시|발마사지|타이마사지|풋마사지|스포츠마사지|림프|테라피|족욕|디톡스\s*족욕|상담센터|심리상담|발달센터|치유센터|금거래소|금은방|귀금속|결혼정보|소개팅|컨설팅|신당|신점|보살|운전면허/.test(s)) return '기타';
